...
export class Header {
  ...
  constructor (
    ...
    this.logoBase = `https://api.sistemaspleno-homolog.com/api/vistoria/logo-imobiliaria?host=${this.backend.urlSistema}/logo-imobiliaria?host=${this.backend.urlSistema}`;
  }
